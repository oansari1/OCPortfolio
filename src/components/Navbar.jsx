...
export default function Navbar() {
    ...
    return (
        <header className="w-full md:min-w-screen bg-[#3A3A3A] pb-0 flex flex-col md:flex-row justify-between items-end z-10 fixed top-0 left-0 right-0 md:relative md:z-0 text-center shadow-xl shadow-neutral-900">
            <nav className="w-full md:min-w-full mx-auto -mt-3 px-6 flex flex-col md:flex-row justify-between items-end">
                <div className="flex w-full justify-between items-end">
                    <div className="flex flex-col items-start mt-4">
                        <h1 className="text-5xl text-[#FA9600] tracking-wider ml-2 mb-2">
                ...
                <ul
                    className={`text-2xl font-bold mr-2 relative w-full md:w-auto justify-center md:justify-end items-center md:items-end transition-all duration-300
                    ${menuOpen ? "flex flex-row space-x-8" : "hidden"} md:flex md:flex-row md:space-x-2 lg:space-x-8`}
                >
